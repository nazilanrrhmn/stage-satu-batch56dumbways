  ...
  dataProject.forEach((project, index) => {
    document.getElementById("content").innerHTML += `
          ...
          project.postAt
                  ...
                  <div class="card-body">
                      <a href="/detail-project/${index}" class="card-title">${
                          project.projectName
                      }</a>
                      <p class="card-text">
                          ${project.description}
                      ...
                      <div class="card-actions d-flex justify-content-end">
                          <a href="/edit-project?index=${index}" class="btn btn-secondary me-2">Edit</a>
...
function deleteProject(index) {
  if (confirm("Are you sure you want to delete this project?")) {
    ...
    renderProject(); // Refresh project list
  }
}
...
//                       )}<br />
//                       <div class="card-actions d-flex justify-content-end">
//                           <a href="/edit-project/<%= id %>" class="btn btn-secondary me-2">Edit</a>
//                           <button class="btn btn-danger" onclick="deleteProject(<%= index %>)">Delete</button>
//                       </div>
//                   </div>
//               </div>
